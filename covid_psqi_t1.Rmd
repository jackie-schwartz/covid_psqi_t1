...
# reading in data
```{r}
covidt1_fp <- "~/Box/mooddata_nophi/ELS_RDoC/T-COVID-19/DATA/ELS_COVID_T1_Final_Child_Raw.csv"
...
```{r}
covid_psqi_t1_fp <- "~/Box/Mooddata_Coordinating/1_Lab_Coordinating/Users/JackieSchwartz/COVID19/covid_psqi_t1.csv"
